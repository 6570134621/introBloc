  ...
  String get urlString {
    switch (this) {
      case PersonUrl.persons1:
        return 'http://127.0.0.1:5500/testingbloc_course/api/person1.json';
      case PersonUrl.persons2:
        return 'http://127.0.0.1:5500/testingbloc_course/api/person2.json';
    }
  }
}
...
extension Subscript<N> on Iterable<N> {
  N? operator [](int index) => length > index ? elementAt(index) : null;
}
